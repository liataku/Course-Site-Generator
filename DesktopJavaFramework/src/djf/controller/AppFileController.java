...
//    TAData data = (TAData) app.getDataComponent();
   ...
   /* public void handleExport(){
        ...
        String path = currentDir.getParentFile().getParentFile().getPath();
       
        //String path = "../TAManagerTester/public_html/";
	...
	fc.setTitle(props.getProperty(EXPORT_WORK_TITLE));
        ...
        String officePath = "../TAManagerTester/public_html/js/";
