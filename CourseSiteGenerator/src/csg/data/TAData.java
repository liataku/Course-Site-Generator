...
import csg.controllers.EmailValidator;
 ...
 */
public class TAData extends AppWorkspaceComponent implements AppDataComponent {
    ...
    // Creating The pane objects that are going to be used to display the workspace
...
//        if (hour < startHour)
    ...
    public void addTA(String initName, String initEmail) {
        ...
        if (!containsTA(initName, initEmail)) {
            ...
            RecitationTab recitation = workspace.getRecitationTab();
            recitation.setTAList();
     ...
     public void addTA(String initName, String initEmail,boolean grad) {
        // MAKE THE TA
        TeachingAssistant ta = new TeachingAssistant(initName, initEmail);
    ...
    public void replaceTAName(String name, String newName){
        ...
        for(Pane p : taTab.getOfficeHoursGridTACellPanes().values()){
